...
from blog.forms import RegistrationForm , LoginForm , UpdateAccountForm , PostForm , ResetPasswordForm , RequestResetForm
...
def update_post(post_id):
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash(f'You post has been updated!!' , 'success')
...
If you did not make this request simply ignore the message and no chnages will be made. 
'''
    mail.send(msg)
...
def reset_token(token):
    ...
    if user is None:
        flash(f'That token is an invalid token or expired !' , 'warning')
